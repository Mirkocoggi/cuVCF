...
def save_pd_to_csv_in_chunks(df, filename, npartitions=10, index=False):
...
end_run = time.perf_counter()
time_elapsed = time_elapsed+(end_run - start_run)
print(f"Dataframe created in : {time_elapsed:.4f} seconds")

start_run = time.perf_counter()
npartitions = 10  
save_pd_to_csv_in_chunks(df1, "df1.csv", npartitions, index=False)
save_pd_to_csv_in_chunks(df2, "df2.csv", npartitions, index=False)
save_pd_to_csv_in_chunks(df3, "df3.csv", npartitions, index=False)
save_pd_to_csv_in_chunks(df4, "df4.csv", npartitions, index=False)
end_run = time.perf_counter()
time_elapsed = time_elapsed+(end_run - start_run)
...
end_run = time.perf_counter()
print(f"Filter POS > 140680000: {end_run - start_run:.4f} seconds")
print(len(df1))
print(len(df11))
del df11
gc.collect()
...
end_run = time.perf_counter()
print(f"Filter POS > 140680000 & POS < 160680000: {end_run - start_run:.4f} seconds")
print(len(df1))
print(len(df11))
del df11
gc.collect()
...
start_run = time.perf_counter()
df11 = df1[(df1["E_Multiple_observations"] == 0) & (df1["TSA"] == "SNV")]
end_run = time.perf_counter()
...
end_run = time.perf_counter()
print(f"Filter POS > 140680000 & E_Multiple_observations: {end_run - start_run:.4f} seconds")
print(len(df1))
print(len(df11))
del df11
gc.collect()
...
end_run = time.perf_counter()
print(f"Filter POS > 140680000 & POS < 160680000 & E_Multiple_observations: {end_run - start_run:.4f} seconds")
print(len(df1))
print(len(df11))
del df11
gc.collect()
...
start_run = time.perf_counter()
df11 = df1[(df1["pos"] > 140680000) & (df1["TSA"] == "SNV")]
end_run = time.perf_counter()
print(f"Filter POS > 140680000 & TSA=SNV : {end_run - start_run:.4f} seconds")
print(len(df1))
print(len(df11))
del df11
gc.collect()
...
start_run = time.perf_counter()
df11 = df1[(df1["pos"] > 140680000) & (df1["pos"] < 160680000) & (df1["TSA"] == "SNV")]
end_run = time.perf_counter()
print(f"Filter POS > 140680000 & POS < 160680000 & TSA=SNV: {end_run - start_run:.4f} seconds")
print(len(df1))
print(len(df11))
del df11
gc.collect()
...
start_run = time.perf_counter()
df11 = df1[(df1["pos"] > 140680000) & (df1["TSA"] == "SNV") & (df1["EVA_4"] == 1)]
end_run = time.perf_counter()
print(f"Filter POS > 140680000 & TSA=SNV : {end_run - start_run:.4f} seconds")
print(len(df1))
print(len(df11))
...
start_run = time.perf_counter()
df11 = df1[(df1["pos"] > 140680000) & (df1["pos"] < 160680000) & (df1["TSA"] == "SNV") & (df1["EVA_4"] == 1)]
end_run = time.perf_counter()
print(f"Filter POS > 140680000 & POS < 160680000 & TSA=SNV: {end_run - start_run:.4f} seconds")
print(len(df1))
print(len(df11))

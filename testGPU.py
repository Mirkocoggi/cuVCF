...
# Misura il tempo per eseguire il run
start_run = time.perf_counter()
res.run("data/bos_taurus.vcf", 8)
end_run = time.perf_counter()
run_time = end_run - start_run
print(f"Tempo di esecuzione di run: {run_time:.4f} secondi")

# Misura il tempo per creare i dizionari e i DataFrame
...
print(f"Tempo di creazione dei DataFrame: {df_time:.4f} secondi")

# Misura il tempo per salvare i DataFrame in CSV

...
print(f"Filter AF>=0.5: {end_run - start_run:.4f} secondi")
print(len(df2))
print(len(df22))
...
df22 = df2[df2["AC"] >= 10]
end_run = time.perf_counter()
print(f"Filter AC>=10: {end_run - start_run:.4f} secondi")
print(len(df2))
print(len(df22))

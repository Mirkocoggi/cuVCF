...
echo "Filter executed: $filter_expr" > ../result/Vcflib_result_danio.txt
echo "Filter executed: $filter_expr" > ../result/Vcflib_result_danio.txt
start=$(date +%s%N)
...
echo "Time: ${runtime_ms} ms" >> ../result/Vcflib_result_danio.txt
echo "" >> ../result/Vcflib_result_danio.txt
echo "Time: ${runtime_ms} ms" >> ../result/Vcflib_result_danio.txt
echo "" >> ../result/Vcflib_result_danio.txt
